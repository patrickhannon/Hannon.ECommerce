    ...
    public class CategoryService : ICategoryService
    {
                ...
                int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
            {
                ...
                //It's much faster with a large number of categories than the LINQ implementation below 
                    ...
                    return new PagedList<Category>(categories, pageIndex, pageSize, categories.Count);
            ...
            {
                var key = string.Format(HanCatalogDefaults.CategoriesByParentCategoryIdCacheKey, parentCategoryId, showHidden, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
            ...
            {
                var cacheKey = string.Format(HanCatalogDefaults.CategoriesChildIdentifiersCacheKey,
                    parentCategoryId,
            ...
            public virtual Category GetCategoryById(int categoryId)
            {
                ...
                var key = string.Format(HanCatalogDefaults.CategoriesByIdCacheKey, categoryId);
            ...
            public virtual void InsertCategory(Category category)
            {
                ...
                //cache
                _cacheManager.RemoveByPattern(HanCatalogDefaults.CategoriesPatternCacheKey);
                _staticCacheManager.RemoveByPattern(HanCatalogDefaults.CategoriesPatternCacheKey);
                _cacheManager.RemoveByPattern(HanCatalogDefaults.ProductCategoriesPatternCacheKey);
                ...
                int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
            {
                ...
                var key = string.Format(HanCatalogDefaults.ProductCategoriesAllByCategoryIdCacheKey, showHidden, categoryId, pageIndex, pageSize, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
                return _cacheManager.Get(key, () =>
                {
            ...
            public virtual IList<ProductCategory> GetProductCategoriesByProductId(int productId, int storeId, bool showHidden = false)
            {
                ...
                var key = string.Format(HanCatalogDefaults.ProductCategoriesAllByProductIdCacheKey, showHidden, productId, _workContext.CurrentCustomer.Id, storeId);
                return _cacheManager.Get(key, () =>
                {
                    var query = from pc in _productCategoryRepository.Table
                                join c in _categoryRepository.Table on pc.CategoryId equals c.Id
        ...
        //Data.Entities.Category ICategoryService.GetCategoryById(int categoryId)
        //{
